...
"   call Decho("set up 8-color highlighting groups")
   ...
   hi ansiRed               ctermfg=Red              guifg='#fb9fb1'                              cterm=NONE              gui=NONE
   hi ansiGreen             ctermfg=Green            guifg='#acc267'                            cterm=NONE                gui=NONE
   hi ansiYellow            ctermfg=Yellow           guifg='#ddb26f'                           cterm=NONE                 gui=NONE
   ...
   hi ansiRedFg             ctermfg=Red              guifg='#fb9fb1'                              cterm=NONE              gui=NONE
   hi ansiGreenFg           ctermfg=Green            guifg='#acc267'                            cterm=NONE                gui=NONE
   hi ansiYellowFg          ctermfg=Yellow           guifg='#ddb26f'                           cterm=NONE                 gui=NONE
   ...
   hi ansiBoldRed           ctermfg=Red              guifg='#fb9fb1'                              cterm=bold              gui=bold
   hi ansiBoldGreen         ctermfg=Green            guifg='#acc267'                            cterm=bold                gui=bold
   hi ansiBoldYellow        ctermfg=Yellow           guifg='#ddb26f'                           cterm=bold                 gui=bold
   ...
   hi ansiReverseRed        ctermfg=Red              guifg='#fb9fb1'                              cterm=reverse           gui=reverse
   hi ansiReverseGreen      ctermfg=Green            guifg='#acc267'                            cterm=reverse             gui=reverse
   hi ansiReverseYellow     ctermfg=Yellow           guifg='#ddb26f'                           cterm=reverse              gui=reverse
   ...
   hi ansiStandoutRed       ctermfg=Red              guifg='#fb9fb1'                              cterm=standout          gui=standout
   hi ansiStandoutGreen     ctermfg=Green            guifg='#acc267'                            cterm=standout            gui=standout
   hi ansiStandoutYellow    ctermfg=Yellow           guifg='#ddb26f'                           cterm=standout             gui=standout
   ...
   hi ansiItalicRed         ctermfg=Red              guifg='#fb9fb1'                              cterm=italic            gui=italic
   hi ansiItalicGreen       ctermfg=Green            guifg='#acc267'                            cterm=italic              gui=italic
   hi ansiItalicYellow      ctermfg=Yellow           guifg='#ddb26f'                           cterm=italic               gui=italic
   ...
   hi ansiUnderlineRed      ctermfg=Red              guifg='#fb9fb1'                              cterm=underline         gui=underline
   hi ansiUnderlineGreen    ctermfg=Green            guifg='#acc267'                            cterm=underline           gui=underline
   hi ansiUnderlineYellow   ctermfg=Yellow           guifg='#ddb26f'                           cterm=underline            gui=underline
   ...
   hi ansiBlinkRed          ctermfg=Red              guifg='#fb9fb1'                              cterm=standout          gui=undercurl
   hi ansiBlinkGreen        ctermfg=Green            guifg='#acc267'                            cterm=standout            gui=undercurl
   hi ansiBlinkYellow       ctermfg=Yellow           guifg='#ddb26f'                           cterm=standout             gui=undercurl
   ...
   hi ansiRapidBlinkRed     ctermfg=Red              guifg='#fb9fb1'                              cterm=standout          gui=undercurl
   hi ansiRapidBlinkGreen   ctermfg=Green            guifg='#acc267'                            cterm=standout            gui=undercurl
   hi ansiRapidBlinkYellow  ctermfg=Yellow           guifg='#ddb26f'                           cterm=standout             gui=undercurl
   ...
   hi ansiRVRed             ctermfg=Red              guifg='#fb9fb1'                              cterm=reverse           gui=reverse
   hi ansiRVGreen           ctermfg=Green            guifg='#acc267'                            cterm=reverse             gui=reverse
   hi ansiRVYellow          ctermfg=Yellow           guifg='#ddb26f'                           cterm=reverse              gui=reverse
   ...
   hi ansiRedDefault          ctermfg=Red            ctermbg=NONE      guifg='#fb9fb1' guibg=NONE      cterm=NONE         gui=NONE
   hi ansiGreenDefault        ctermfg=Green          ctermbg=NONE      guifg='#acc267' guibg=NONE      cterm=NONE         gui=NONE
   hi ansiYellowDefault       ctermfg=Yellow         ctermbg=NONE      guifg='#ddb26f' guibg=NONE      cterm=NONE         gui=NONE
   ...
   hi ansiRedBlack          ctermfg=Red              ctermbg=Black     guifg='#fb9fb1' guibg=Black     cterm=NONE         gui=NONE
   hi ansiGreenBlack        ctermfg=Green            ctermbg=Black     guifg='#acc267' guibg=Black     cterm=NONE         gui=NONE
   hi ansiYellowBlack       ctermfg=Yellow           ctermbg=Black     guifg='#ddb26f' guibg=Black     cterm=NONE         gui=NONE
   ...
   hi ansiRedRed            ctermfg=Red              ctermbg=Red       guifg='#fb9fb1' guibg=Red       cterm=NONE         gui=NONE
   hi ansiGreenRed          ctermfg=Green            ctermbg=Red       guifg='#acc267' guibg=Red       cterm=NONE         gui=NONE
   hi ansiYellowRed         ctermfg=Yellow           ctermbg=Red       guifg='#ddb26f' guibg=Red       cterm=NONE         gui=NONE
   ...
   hi ansiRedGreen          ctermfg=Red              ctermbg=Green     guifg='#fb9fb1' guibg=Green     cterm=NONE         gui=NONE
   hi ansiGreenGreen        ctermfg=Green            ctermbg=Green     guifg='#acc267' guibg=Green     cterm=NONE         gui=NONE
   hi ansiYellowGreen       ctermfg=Yellow           ctermbg=Green     guifg='#ddb26f' guibg=Green     cterm=NONE         gui=NONE
   ...
   hi ansiRedYellow         ctermfg=Red              ctermbg=Yellow    guifg='#fb9fb1' guibg=Yellow    cterm=NONE         gui=NONE
   hi ansiGreenYellow       ctermfg=Green            ctermbg=Yellow    guifg='#acc267' guibg=Yellow    cterm=NONE         gui=NONE
   hi ansiYellowYellow      ctermfg=Yellow           ctermbg=Yellow    guifg='#ddb26f' guibg=Yellow    cterm=NONE         gui=NONE
   ...
   hi ansiRedBlue           ctermfg=Red              ctermbg=Blue      guifg='#fb9fb1' guibg=Blue      cterm=NONE         gui=NONE
   hi ansiGreenBlue         ctermfg=Green            ctermbg=Blue      guifg='#acc267' guibg=Blue      cterm=NONE         gui=NONE
   hi ansiYellowBlue        ctermfg=Yellow           ctermbg=Blue      guifg='#ddb26f' guibg=Blue      cterm=NONE         gui=NONE
   ...
   hi ansiRedMagenta        ctermfg=Red              ctermbg=Magenta   guifg='#fb9fb1' guibg=Magenta   cterm=NONE         gui=NONE
   hi ansiGreenMagenta      ctermfg=Green            ctermbg=Magenta   guifg='#acc267' guibg=Magenta   cterm=NONE         gui=NONE
   hi ansiYellowMagenta     ctermfg=Yellow           ctermbg=Magenta   guifg='#ddb26f' guibg=Magenta   cterm=NONE         gui=NONE
   ...
   hi ansiRedCyan           ctermfg=Red              ctermbg=Cyan      guifg='#fb9fb1' guibg=Cyan      cterm=NONE         gui=NONE
   hi ansiGreenCyan         ctermfg=Green            ctermbg=Cyan      guifg='#acc267' guibg=Cyan      cterm=NONE         gui=NONE
   hi ansiYellowCyan        ctermfg=Yellow           ctermbg=Cyan      guifg='#ddb26f' guibg=Cyan      cterm=NONE         gui=NONE
   ...
   hi ansiRedWhite          ctermfg=Red              ctermbg=LightGray guifg='#fb9fb1' guibg=LightGray cterm=NONE         gui=NONE
   hi ansiGreenWhite        ctermfg=Green            ctermbg=LightGray guifg='#acc267' guibg=LightGray cterm=NONE         gui=NONE
   hi ansiYellowWhite       ctermfg=Yellow           ctermbg=LightGray guifg='#ddb26f' guibg=LightGray cterm=NONE         gui=NONE
   ...
   hi ansiRedGray           ctermfg=Red              ctermbg=Gray      guifg='#fb9fb1' guibg=Gray      cterm=NONE         gui=NONE
   hi ansiGreenGray         ctermfg=Green            ctermbg=Gray      guifg='#acc267' guibg=Gray      cterm=NONE         gui=NONE
   hi ansiYellowGray        ctermfg=Yellow           ctermbg=Gray      guifg='#ddb26f' guibg=Gray      cterm=NONE         gui=NONE
